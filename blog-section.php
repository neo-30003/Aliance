...
<header class="page-header <?= $header_style;?>">
  <div class="container">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="breadcrumbs-item">
        <a href="./contracts.php" class="breadcrumbs-link">Блог</a>
      </li>
...
<section class="section blog-subpage">
  <div class="container">
    <div class="blog-subpage-wrapper ">
      <div class="blog-subpage-content">
        <h3 class="section-title blog-subpage-content-title">Реализация намеченных плановых заданий</h3>
        <p class="blog-subpage-text">
        ...
        <h4 class="section-title blog-subpage-title">Равным образом консультация с широким активом</h4>
        <p class="blog-subpage-content-text">
        ...
        <picture class="blog-subpage-image">
          <source class="blog-subpage-image" type="image/webp" srcset="img/blog/blog-photo.webp">
          <source class="blog-subpage-image" type="image/jpeg" srcset="img/blog/blog-photo.jpeg">
          <img class="blog-subpage-image" src="img/blog/blog-photo.jpeg" alt="">
        </picture>
        <h5 class="section-title blog-subpage-list-title">Равным образом консультация с широким активом</h5>
        <ul class="blog-subpage-features-list">
          <li class="blog-subpage-features-item">
        ...
        <ol class="blog-features-list">
          <li class="blog-features-item">
            <span class="blog-features-num">01.</span>
            Идейные соображения высшего порядка, а также консультация с широким активом требуют определения и уточнения позиций.
          </li>
          <li class="blog-features-item">
            <span class="blog-features-num">02.</span>
            С другой стороны консультация с широким активом позволяет оценить значение форм развития.
          </li>
          <li class="blog-features-item">
            <span class="blog-features-num">03.</span>
            Разнообразный и богатый опыт реализация намеченных плановых заданий позволяет выполнять важные задания.
          </li>
        </ol>
      </div>
      <div class="blog-subpage-social">
        <p class="blog-subpage-social-text">
          Поделиться:
        </p>
        <ul class="blog-subpage-social-list">
          <li class="blog-subpage-social-links-item">
            <svg class="Vk-svg" width="24" height="24">
              <use href="img/sprite.svg#Vk"></use>
            </svg>
          </li>
          <li class="blog-subpage-social-links-item">
            <svg class="Facebook-svg" width="24" height="24">
              <use href="img/sprite.svg#facebook"></use>
            </svg>
          </li>
          <li class="blog-subpage-social-links-item">
            <svg class="Twitter-svg" width="24" height="24">
              <use href="img/sprite.svg#twitter"></use>
            </svg>
          </li>
          <li class="blog-subpage-social-links-item">
            <svg class="Google-svg" width="24" height="24">
...
<section class="section blog">
  <div class="container">
    ...
    <div class="swiper blog-slider">
      ...
      <div class="blog-subpage-slider-footer">
        <div class="blog-buttons primary-subpage-buttons-wrapper">
          <div class="blog-button-prev primary-subpage-button-prev">
            <svg width="30" height="20">
              <use href="img/sprite.svg#small-arrow-prev"></use>
            </svg>
          </div>
          <div class="blog-button-next primary-subpage-button-next">
            <svg width="30" height="20">
